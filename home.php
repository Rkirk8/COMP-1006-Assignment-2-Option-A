...
?>
<h2>Welcome to the Barrie RFC Coach Portal.</h2>
<p>In the Coach Portal anonymous users can view the player list on the veiw team page. They can also view the starters on the Decklist page.<br>
